...
# create an instance of LED PWM controller object
pi_pwm = PiPwm()
...
# get the green led duty cycle (%) by GET method from curl. For example:
# curl http://iot8e3c:5000/led_green/1
# -----------------------------------------------------------------------------
...
# get the red led duty cycle (%) by GET method from curl. For example:
# curl http://iot8e3c:5000/led_red/1
# -----------------------------------------------------------------------------
...
def set_motor_pos(position):
    pi_smc.getPosition(position)
    return "Set Motor Direction : " + str(pi_smc.getPosition()) + "\n"
